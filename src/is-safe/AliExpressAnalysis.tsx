...
useEffect(() => {
  ...
  "url": "https://www.aliexpress.com"
          ...
          "reviewBody": "AliExpress is a popular global marketplace owned by Alibaba Group, offering a wide range of low-cost products directly from manufacturers. While the platform is legitimate and provides buyer protection, users should carefully check seller ratings, product reviews, and shipping times, as quality and delivery can vary significantly."
        },
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, AliExpress uses high-level encryption. However, for maximum safety, we recommend using virtual cards or PayPal."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "It is a guarantee that you will get your money back if the item is not as described or if it is not delivered within the promised period."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Check for stores with low positive feedback (below 90%) and those that have been open for less than 6 months. Use Fraudara to verify store URLs."
              }
            }
          ]
        },
