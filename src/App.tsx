          ...
          <div className={`bg-gradient-to-br ${cfg.bg} rounded-3xl border-2 ${cfg.border} shadow-xl p-8 mb-8`}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <button onClick={handleShare} className="flex-1 flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 rounded-xl transition-all text-sm"> <Share2 className="w-4 h-4 flex-shrink-0" /> {t('shareWhatsApp')} </button>
